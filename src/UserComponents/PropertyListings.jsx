...
const PropertyListing = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(searchResults);
  ...
  useEffect(() => {
    const newSearchResults = location.state?.properties || [];
    setFilteredProperties(newSearchResults);
  }, [location.state]);
      ...
      <div className="w-full lg:w-1/4 p-4 bg-gray-100 overflow-auto">
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full p-2 border bg-slate-700 text-slate-200 border-gray-300 rounded"
          >
      ...
      <div className="w-full lg:w-3/4 p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProperties.length > 0 ? (
            ...
            <p className="text-center text-2xl">No properties found.</p>
          )}
        </div>
      </div>
    </div>
